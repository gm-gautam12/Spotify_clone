class AppVectors {
  ...
  static String basePath = 'assets/vectors/';
  static String extension = '.svg';

  static String logo = '${basePath}logo_spotify$extension';
  static String lightMode = '${basePath}sun$extension';
